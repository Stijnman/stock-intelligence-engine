...
- [x] **Analyst Estimate Revision Velocity & Breadth Overlay**. Track the speed, direction, and coverage-breadth of consensus EPS/revenue estimate revisions across the sell-side; rapid upward revisions with rising breadth as soft confirmation of narrative durability, sharp downward revisions as caution even when social heat remains elevated. Fully wired into analyzer / CLI / dashboard / config (v2.31.0, 2026-09-09). Synthetic proxy with AI/semi bias; soft boost on upward velocity + breadth, caution on downward.
- [x] **Patent & Intellectual Property Filing Momentum Overlay**. Monitor USPTO/EPO patent applications, grants, and forward-citation velocity as a forward-looking innovation and economic-moat signal; soft boost for names showing accelerating high-quality patent activity that aligns with or leads the current narrative theme (especially AI / semiconductor / biotech). Fully wired into analyzer / CLI / dashboard / config (v2.32.0, 2026-09-10). Synthetic proxy with AI/semi/biotech bias; soft boost on accelerating filing + citation velocity + grant ratio, caution on deceleration.
...
- [x] **Cross-Ticker Narrative Contagion Detector**. Measure when attention or sentiment on one ticker rapidly transfers to correlated names inside the same theme. Fully wired into analyzer / CLI / dashboard / config (v2.30.0, 2026-09-08). Synthetic cluster proxy with thematic adjacency (AI / consumer / energy / meme); soft boost on inbound contagion, caution on reverse.
...
Last updated: 2026-09-10 (v2.32.0 — Patent & Intellectual Property Filing Momentum Overlay fully implemented and wired)
