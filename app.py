"""Stock Intelligence Engine — Streamlit Dashboard v2.40.0.

TRACE Corporate-Bond Customer Flow & Liquidity +
...
with st.sidebar:
    ...
    st.divider()
    st.markdown(
        f"**v{__version__}** — TRACE Flow + Whisper Number + News-Source Authority + Earnings-Call Transcript + Credit Spread / CDS + Social Intent + GEX + Digital Footprint + Patent & IP Filing Momentum + Analyst Estimate Revision Velocity + Cross-Ticker Contagion + Borrow Fee / Squeeze Risk + Consumer Spend Nowcast + Authenticity Filter + "
...
def signal_table_fragment():
    ...
    preferred = [
        ...
        "trace_customer_flow", "trace_liq_score", "trace_dispersion", "trace_boost", "trace_reason",
