...
with st.sidebar:
    ...
    st.divider()
    st.markdown(
        f"**v{__version__}** — Earnings-Call Transcript + Credit Spread / CDS + Social Intent + GEX + Digital Footprint + Patent & IP Filing Momentum + Analyst Estimate Revision Velocity + Cross-Ticker Contagion + Borrow Fee / Squeeze Risk + Consumer Spend Nowcast + Authenticity Filter + "
...
st.title(
    ...
    "Earnings-Call Transcript Sentiment & Guidance Drift + Corporate Credit Spread / CDS + Social Trading Action Intent + GEX + Digital Footprint Momentum + Patent & IP Filing Momentum + Analyst Estimate Revision Velocity & Breadth + Cross-Ticker Narrative Contagion + Borrow Fee & Short Squeeze Risk + "
