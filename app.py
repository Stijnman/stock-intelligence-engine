"""Stock Intelligence Engine — Streamlit Dashboard v2.15.1"""
...
st.title("Stock Intelligence Engine v2.15.1 — Options IV Skew + Dark Pool / ATS Flow + Real-time Quotes + Congressional + Portfolio Correlation + Institutional 13F + Prediction Markets + Insider Clusters + Narrative Velocity")
...
st.caption("v2.15.1 — Options IV Skew & Term Structure Overlay live · Autonomous evolution cycle active")
