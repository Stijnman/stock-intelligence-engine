...
* **v2.37.1 (2026-09-21)** : Autonomous research & evolution cycle. Code audit confirmed no remaining High Priority FUTURE items are fully implemented and wired (news-source authority, whisper-number cluster, KOL amplification, ETF AP flow, 10b5-1 / buyback execution, unusual options sweep-vs-block, employee outlook, app-store reviews, retail flow). Nothing removed from FUTURE-IMPROVEMENTS.md. Fresh 2026 research (AltIndex 8-signal alt-data, SentiSense MCP + publisher reliability, Stock Companion FinBERT, TradeAlgo / Unusual Whales AI options flow, StockTools.ai, Sparkle/Neudata 2026 alt-data catalog, tokenized-equity venues). Added five new roadmap items: Job-Posting Skill-Mix & Posted-Compensation Inflation, Cross-Venue Tokenized-Share Basis, Physical Foot-Traffic vs Digital-Demand Divergence, SKU Shelf-Price / Promo-Intensity Nowcast, Auditor-Change / Going-Concern Language Velocity.
